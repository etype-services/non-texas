...
<head profile="<?php print $grddl_profile; ?>">
    ...
    <meta property="og:image"
          content="http://www.auroranewsregister.com/sites/default/files/FB_web_image.gif"/>
    <?php print $styles; ?>
    <?php print $scripts; ?>
</head>
<body class="<?php print $classes; ?>" <?php print $attributes; ?>>
<div id="skip-link">
    <a href="#<?php print $jump_link_target; ?>"
       class="element-invisible element-focusable"><?php print t('Jump to Navigation'); ?></a>
</div>
<?php print $page_top; ?>
<?php print $page; ?>
