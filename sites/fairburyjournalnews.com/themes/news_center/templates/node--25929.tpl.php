...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 2408)
    {
  ...
  <section class="container">
    ...
    <div class="login-help" style="color:#000">
     <p style="color:#000">Forgot your password? <a href="/content/forgot-password" style="color:#000">Click here </a>.</p>
       <!-- <p style="color:#000">Change password? <a hrefcontent="/change-password" style="color:#000">Click here to Change Password</a>.</p>-->
    </div>
  </section>
