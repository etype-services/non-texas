...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 1811)
    {
...
{
   $msg="Your Subscription has been expired  <a href='https://www.etypeservices.com/Subscriber/SignIn.aspx?IssueID=142160&ReturnUrl=https://www.etypeservices.com/Subscriber/ReSubscribe.aspx?PubID=1811'>Click here</a>  to re-subscribe.";
}
else
{
  global $user;
