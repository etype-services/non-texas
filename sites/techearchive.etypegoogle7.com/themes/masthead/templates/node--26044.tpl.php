...
if (isset($_POST['submit'])) {
  ...
  if ($response12->GetPublicationIDResult == -9) {
    ...
    if ($response12->GetPublicationIDResult == 326 /* || $response12->GetPublicationIDResult== 1666 */) {
...
<section class="container">
  ...
  <div class="login-help" style="color:#000">
    <p style="color:#000">Forgot your password? <a
        href="http://www.techetoday.com/forgot-password" style="color:#000">Click
        here </a>.</p>
