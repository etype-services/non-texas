      ...
      <div class="main-menu-second-level-wrapper clearfix">
        <div class="main-menu-second-level-wrapper-inner">
          <nav id="main-menu-second-level"
               class="<?php echo $grid_full_width ?>">
        ...
        <section id="main-content">
          ...
          <div class="main">
            ...
            <?php if ($page['sidebar_second']): ?>
              <aside
                class="sidebar second-sidebar <?php print $sidebar_second_grid_width ?> clearfix">
    ...
    <div class="footer-wrapper clearfix">
      <div class="footer-wrapper-inner">
        <footer id="footer" class="<?php echo $grid_full_width ?>">
          ...
          <!--The following line cannot be changed or removed without violating the terms and service of Surf New Media. Site will be shut down within 24 hours of removal -->
          <span style="font-size:0.8em;"><a href="http://www.surfnewmedia.com">Surf
              New Media</a></span>
        </footer><!-- /footer -->
      </div>
    </div>
