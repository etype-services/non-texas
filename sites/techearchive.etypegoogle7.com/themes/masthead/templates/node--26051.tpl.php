...
if ($fp) {
  ...
  while (!feof($fp)) {
    ...
    if (strcmp($res, "VERIFIED") == 0) {
      ...
      if ($PublicationID == 326) {
        $headers .= 'From: The Teche News ' . "\r\n";
        $subject = "Urgent New subscriber Registration - The Teche News";
        $publname = "The Teche News ";
      }
      /* else
       {
...
<body>
   ...
   <tr>
    ...
    if (strcmp($res, "INVALID") == 0) {
      ...
      if ($PublicationID == 326) {
        $headers .= 'From: The Teche News' . "\r\n";
        $subject = "New subscriber Registration - The Teche News";
        $publname = "The Teche News";
      }
      /*  else
        {
