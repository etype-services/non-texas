...
$param12=array('UserName'=>"$username");
   ...
   // echo "<pre>";
    ...
    else if($response12->GetPublicationIDResult== 255 || $response12->GetPublicationIDResult== 256)
    {
...
<body>
  ...
  <section class="container">
    ...
    <div class="login-help" style="color:#000">
     <p style="color:#000">Forgot your password? <a href="http://www.stmarynow.com/forgot-password" style="color:#000">Click here </a>.</p>
       <!-- <p style="color:#000">Change password? <a href="http://www.stmarynow.com/change-password" style="color:#000">Click here to Change Password</a>.</p>-->
    </div>
  </section>
