...
<div class="product">            
    ...
    <input type="hidden" name="cancel_return" value="http://www.stmarynow.com/node/19023">
    <input type="hidden" name="return" value="http://www.stmarynow.com/node/19492">
    <input type="hidden" name="notify_url" value="http://www.stmarynow.com/payment-status">
