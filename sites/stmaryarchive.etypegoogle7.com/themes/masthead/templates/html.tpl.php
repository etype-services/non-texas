<?php 
$count = 1;
if (isset($_COOKIE["stmary"])) {
    $count = (int)$_COOKIE["stmary"];
}
if($count<=5)
{
setcookie("stmary", $count + 1, time() + (60 * 60 * 24 * 30));
}
else {}
...
<!--POPUP-->  
 ...
 <a href="#" onclick="popup('popUpDiv')" style="margin-right: 3%;"><img src="/sites/all/themes/masthead/templates/popupdata/close_icon.png" width="70" height="70" style="margin-top:1%;"></a></div>
		<?php if($android) { ?><a href="https://play.google.com/store/apps/details?id=com.etype.stmarynow.android.rssviewer" >
		<img src="/sites/all/themes/masthead/templates/popupdata/StMaryAnd.jpg" style="width:100%;border:0px solid;" /> </a> <?php } if($iphone) { ?><a href="https://itunes.apple.com/us/app/st.-mary-now/id979897061?ls=1&mt=8" >
	<img src="/sites/all/themes/masthead/templates/popupdata/StMAryIos.jpg" style="width:100%;border:0px solid;" /></a><?php } ?>
