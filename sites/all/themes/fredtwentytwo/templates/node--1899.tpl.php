...
if (isset($_POST['submit'])) {
  ...
  $client1 = new soapclient('http://etype.sublimeitsolutions.com/Service_EditSubscriberProfile.asmx?wsdl');
...
if (isset($_POST['change'])) {
  ...
  $client1 = new soapclient('http://etype.sublimeitsolutions.com/service_GetPasswordByUserName.asmx?WSDL');
  $resp = $client1->GetPasswordByUserName($param1);
  if ($Password == $resp->GetPasswordByUserNameResult) {
    $param = ['UserName' => $username, 'Password' => $nPassword];


    $client = new soapclient('http://etype.sublimeitsolutions.com/Service_ChangePassword.asmx?WSDL');
        ...
        <p>
            <form name="form2" id="form2" method="POST" action="" enctype="multipart/form-data">
                ...
                <div style="margin-left:80px">
                  ...
                  $client = new soapclient('http://etype.sublimeitsolutions.com/Service_GetDetails_ByUserName.asmx?WSDL');
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text"
                                       ...
                                       name="address" class="txt" required="required"/></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text"
                                       ...
                                       name="city" class="txt" required="required"/></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text"
                                       ...
                                       name="state" class="txt" required="required"/></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text"
                                       ...
                                       name="postalcode" class="txt" required="required"/></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text"
                                       ...
                                       name="phone" class="txt" required="required"/></td>
                        </tr>
                    </table>

                    <div style="margin-top: 22px; margin-bottom: 42px;">
                        <input type="submit" name="submit" onClick="javascript:return validation();" value="Submit"
                        ...
                        <a href="javascript:history.back()"
                           style="text-decoration: none;color: #000;font-weight: bold; float:right;">
                            <div style="width: 93px;float: right;background-color: gainsboro;height: 25px;border: 1px solid #ccc;border-radius: 4px;text-shadow: white 0 1px 1px;">
...
<div id="tabs-2">
    ...
    <table>
        ...
        <td><input type="password" id="oldpassword" required name="oldpassword" pattern=".{6,}"
                   placeholder="Old Password">
        </td>
        </tr>
        <td><strong>New Password</strong>
        </td>
        <td><input type="password" id="newpassword" required name="newpassword" pattern=".{6,}"
        ...
        <tr>
            ...
            <td><input type="password" id="confirmpassword" required name="confirmpassword" pattern=".{6,}"
                       oninput="check(this)" placeholder="Confirm Password">
            </td>
        </tr>
    </table>
