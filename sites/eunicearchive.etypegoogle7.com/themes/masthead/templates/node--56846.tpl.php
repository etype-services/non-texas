...
$pubemail1="vickie.boulet@eunicetoday.com";
$pubemail="jim.butler@eunicetoday.com";
$subemail="pradeep@sublimeitsolutions.com";
$sentmailadmin1=mail($adminemail,$subject,$message,$headers);
//$sentmail=mail($torec,$subject,$message,$headers);
$sentmailp1=mail($pubemail1,$subject,$message,$headers);
$sentmailp2=mail($pubemail,$subject,$message,$headers);
$sentmailp3=mail($subemail,$subject,$message,$headers);
$topay=$payer_email;
$message1="<head>
