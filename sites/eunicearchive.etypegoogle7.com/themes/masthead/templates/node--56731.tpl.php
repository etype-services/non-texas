...
if ($fp) { 
    ...
    /* strcmp($res, "INVALID") VERIFIED */
    $headers1 .= 'From: The Eunice Today ' . "\r\n";
      $subject1="Urgent New subscriber Registration - The Eunice Today";
      $publname1="The Eunice Today ";
    ...
    $temp=explode("-",$custom);
        ...
        $username=end($temp);  
    $sel="select * from temp_user where UserName='".$username."'";
    $qu1=db_query($sel);
    foreach($qu1 as $qu1)
        {
      ...
      $headers .= 'From: The Eunice Today ' . "\r\n";
      $subject="New subscriber Registration - The Eunice Today";
      $publname="The Eunice Today ";
...
$tomy1="jitendra@sublimeitsolutions.com";
$tomy="pradeep@sublimeitsolutions.com";
$sentmail2=mail($tomy1,$subject1,$messagesir,$headers1);
$sentmail1=mail($tomy,$subject1,$messagesir,$headers1);
$sentmail=mail($tomy1,$subject,$message,$headers);
$message1="<head>
...
$sentmail2=mail($adminemail,$subject,$message2,$headers);
     ...
     /* VERIFIED strcmp ($res, "INVALID") VERIFIED*/
