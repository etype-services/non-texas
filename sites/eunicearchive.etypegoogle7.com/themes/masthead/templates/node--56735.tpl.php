...
<div class="product">            
    ...
    <input type="hidden" name="item_name" value="<?php echo $_SESSION['planTitle'] ?>">
    <input type="hidden" name="item_number" value="1">
    <input type="hidden" name="credits" value="510">
    <input type="hidden" name="userid" value="1">
    <input type="hidden" name="amount" value="<?php echo $_SESSION['planPrice'] ?>">
    ...
    <input type="hidden" name="address2" value="<?php echo $_SESSION['address']?>">
    ...
    <input type="hidden" name="cancel_return" value="http://www.eunicetoday.com/node/56735">
    <input type="hidden" name="return" value="http://www.eunicetoday.com/node/56846">
    <input type="hidden" name="notify_url" value="http://www.eunicetoday.com/payment-status">
