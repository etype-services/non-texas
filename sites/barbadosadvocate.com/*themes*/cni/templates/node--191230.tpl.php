...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 3053)
    {
...
{
   $msg="Your Subscription has been expired  <a href='http://www.etypeservices.com/Subscriber/SignIn.aspx?ReturnUrl=http://www.etypeservices.com/SWF/LocalUser/Fernandina1//Magazine105186/Trial/index.aspx?II=105186&IssueID=105186'>Click here</a>  to re-subscribe.";
}
else
{
  global $user;
