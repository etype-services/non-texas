<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>> 
  ...
  <div class="node-content-wrapper">                    
    ...
    <div class="view-more-digital"><a href="http://www.etypeservices.com/Barbados%20AdvocateID432/">To view more please log in or subscribe to the digital edition.</a></div>
