...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 315 || $response12->GetPublicationIDResult== 1659 ||  $response12->GetPublicationIDResult== 1660)
    {
...
<body>
  ...
  <section class="container">
    ...
    <div class="login-help" style="color:#000">
     <p style="color:#000">Forgot your password? <a href="http://www.vermiliontoday.com/forgot-password" style="color:#000">Click here </a>.</p>
       <!-- <p style="color:#000">Change password? <a href="http://etypeservices6.net/eunice/change-password" style="color:#000">Click here to Change Password</a>.</p>-->
    </div>
  </section>
