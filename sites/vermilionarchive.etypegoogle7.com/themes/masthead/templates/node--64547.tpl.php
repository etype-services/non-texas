  ...
  //    echo "<pre>";
      ...
      ?>
       <form  name="planform" method="POST" action="http://www.vermiliontoday.com/checkout" enctype="multipart/form-data">
<fieldset>
    <style>
...
<div class="headerdl">
  <?php if($_POST['publication']==315) {?>
  <img src="http://www.vermiliontoday.com/sites/default/files/abbeville.jpg" width="380" height="100%"></div>
<?php } if($_POST['publication']==1659) { ?>
<img src="http://www.vermiliontoday.com/sites/default/files/kaplan.jpg" width="380" height="75%">
<?php } if($_POST['publication']==1660) {  ?>
<img src="http://www.vermiliontoday.com/sites/default/files/gueydan.jpg" width="380" height="98%">
<?php } ?>
</div></div>
...
<br/>
<strong>Already a print subscriber? <a href="http://www.vermiliontoday.com/already-print-subscriber" style="color:red">Fill out this form</a> to activate your digital subscription. Once your print subscription is verified, your user account will be enabled.</strong>
             </p>
...
<br /><br />
<?php if($_POST['publication']==315) {?>
  <strong><h3>The Abbeville Meridional</h3></strong>

<?php } if($_POST['publication']==1659) { ?>

 <strong><h3>Kaplan Herald</h3></strong><?php } if($_POST['publication']==1660) {  ?>
 <strong><h3>Gueydan Journal</h3></strong>
  <?php } ?>
<br/>
<?php
                $i=0;
