...
drupal_goto('http://www.vermiliontoday.com');
...
1.1 This website (the "Site") is owned by vermiliontoday.com and Louisiana State Newspapers, Inc. (also referred to as "we" or "us"). By using the Site and the services, information, and materials provided on or through the Site (collectively, the "Service"), you agree to abide by all of the terms and conditions of this Agreement.<br />
...
2.4 Certain Content may be furnished by wire services, such as the Associated Press. Neither we nor the wire services will be liable for any delays, inaccuracies, errors, or omissions in any such Content, or in the transmission or delivery of all or any part thereof, or for any damages arising therefrom.3. Forums and Discussions<br />
...
3.5 The Forums must be used only in a noncommercial manner. You will not, without our express prior written approval, distribute or otherwise publish any material containing any solicitation of funds, advertising, or solicitation for goods or services.<br />
...
6.2 You agree to notify help@lsnweb.com of any known or suspected unauthorized use of your account, or any known or suspected breach of security, including loss, theft, or unauthorized disclosure of your password or credit card information.<br />
...
10.1 You may terminate your account at any time by e-mail sent to: cancel@lsnweb.com. Upon termination, you will receive an automated confirmation by e-mail that the request was received, and your access will be suspended within 24 hours. You are responsible for all charges incurred up to the time the account is deactivated.<br />
