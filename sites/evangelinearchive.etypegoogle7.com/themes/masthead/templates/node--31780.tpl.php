...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 317 || $response12->GetPublicationIDResult== 1666 )
    {
...
<body>
  ...
  <section class="container">
    ...
    <div class="login-help" style="color:#000">
     <p style="color:#000">Forgot your password? <a href="http://www.evangelinetoday.com/forgot-password" style="color:#000">Click here </a>.</p>
