<?php 
$count = 1;
if (isset($_COOKIE["evangeline"])) {
    $count = (int)$_COOKIE["evangeline"];
}
if($count<=5)
{
setcookie("evangeline", $count + 1, time() + (60 * 60 * 24 * 30));
}
else {}
...
<!--POPUP-->  
 ...
 <a href="#" onclick="popup('popUpDiv')" style="margin-right: 3%;"><img src="/sites/all/themes/masthead/templates/popupdata/close_icon.png" width="70" height="70" style="margin-top:1%;"></a></div>
		<?php if($android) { ?><a href="https://play.google.com/store/apps/details?id=com.etype.evangelinetoday.android.rssviewer&hl=en" >
		<img src="/sites/all/themes/masthead/templates/popupdata/EvangelineAnd.jpg" style="width:100%;border:0px solid;" /> </a> <?php } if($iphone) { ?><a href="https://itunes.apple.com/us/app/evangeline-today/id979893988?ls=1&mt=8" >
	<img src="/sites/all/themes/masthead/templates/popupdata/EvangelineIos.jpg" style="width:100%;border:0px solid;" /></a><?php } ?>
